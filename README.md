...
Le Sprint 1 ajoute la carte interactive et le dépôt sécurisé des premières propositions citoyennes. Avant l'ouverture au public, renseigner les limites territoriales dans `data/territoire.geojson` et, si nécessaire, les communes déléguées dans `data/communes-deleguees.geojson`.
