...
<main class="page-layout">
    ...
    <section class="form-panel">
        <form id="proposal-form" enctype="multipart/form-data" novalidate>
            ...
            <label class="privacy-consent"><input name="notification_consent" type="checkbox" value="1"<?= !empty($user['notification_consent_at']) ? ' checked' : '' ?>> J’accepte de recevoir par e-mail les notifications liées à cette proposition. <a href="<?= htmlspecialchars($routeUrl('/donnees-personnelles'), ENT_QUOTES, 'UTF-8') ?>" target="_blank" rel="noopener noreferrer">En savoir plus</a>.</label>
            <?php if ($treeProposal): ?>
