...
<main class="page-layout">
    ...
    <section class="form-panel">
        <form id="proposal-form" enctype="multipart/form-data" novalidate>
            ...
            <fieldset><legend>Objectifs de plantation</legend><div class="objective-grid"><?php foreach ($planting['objectives'] as $key => $label): ?><label class="objective"><input type="checkbox" name="objectives[]" value="<?= htmlspecialchars($key, ENT_QUOTES, 'UTF-8') ?>"><span><?= htmlspecialchars($label, ENT_QUOTES, 'UTF-8') ?></span></label><?php endforeach; ?></div></fieldset>
